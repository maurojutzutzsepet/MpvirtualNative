...
export default function MyTextInput(props) {
  ...
  return (
    <Input
      ...
      containerStyle={{ marginBottom: 10, borderBottomColor: color.LIGHTPRIMARYCOLOR, borderBottomWidth: 0}}
      inputStyle={{
      ...
      rightIcon={props.bolGone ?
        <TouchableOpacity activeOpacity={0.8} style={styles.btnVisibility} onPress={props.onPress}>
          <Image style={styles.btnImage} tintColor={color.PRIMARYCOLOR}
            source={(props.secureTextEntry) ? require('@recursos/images/block.png') : require('@recursos/images/desblock.png')} />
        </TouchableOpacity> :
